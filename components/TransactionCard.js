    ...
    return (
        ...
        <Pressable
                    ...
                    >
                        ...
                        <Octicons name="person" size={calcHeight(2)} color="white" />
                        <Text style={styles.participants}>{transaction.splitAmong.length}   Participants</Text>
                        ...
                        <EvilIcons name="calendar" size={calcHeight(2)} color="white" />
